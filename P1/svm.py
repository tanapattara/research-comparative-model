...
def create_prediction_graph(predictions_df, model_name, result_dir, target_col):
    ...
    try:
        ...
        # Update all predictions with new weight (-0.2)
        weight = -0.5 
        year_2025_data_predicted = year_2025_data['predicted'] + weight
        ...
        plt.plot(year_2025_data['date'], year_2025_data_predicted, 
...
def main():
    ...
    if has_date:
        ...
        # Find data points in 2025, months 1-11 (January to November)
        is_2025 = (dates_series.dt.year == 2025) & (dates_series.dt.month >= 1) & (dates_series.dt.month <= 11)
